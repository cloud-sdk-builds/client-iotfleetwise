...
[`@aws-sdk/client-iotfleetwise`](https://www.npmjs.com/package/@aws-sdk/client-iotfleetwise/v/3.806.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-iotfleetwise@3.806.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-nvmIB2L56LutLHYBfdJtmaE3JjYviFN/vGOmvcuU7MryMQ4kW1wrmp0FLdrJXPh3
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-iotfleetwise": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-iotfleetwise@3.806.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-iotfleetwise@3.806.0/index.min.mjs": "sha384-nvmIB2L56LutLHYBfdJtmaE3JjYviFN/vGOmvcuU7MryMQ4kW1wrmp0FLdrJXPh3"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-iotfleetwise/blob/refs/tags/3.806.0/LICENSE
```
